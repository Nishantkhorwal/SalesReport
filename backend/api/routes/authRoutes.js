...
import { registerUser, loginUser, editUser, getUser, getAllUsers, getAllManagers, getTeamMembers, getAvailableUsers, getCurrentUser, updateUser, getAllUsersForAdmin, updateOwnProfile } from '../controllers/authController.js';
...
router.put("/profile", authenticateUser, updateOwnProfile);
router.put(
  '/:userId',
  authenticateUser,
  updateUser
