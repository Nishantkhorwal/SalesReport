        ...
        <div className="bg-[#111827] border border-white/10 rounded-xl p-4 grid grid-cols-1 md:grid-cols-5 gap-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-[#0b1220] border border-white/10 rounded-md text-sm focus:outline-none"
            />
          </div>
          ...
          {/* <select
            ...
            className="bg-[#0b1220] border border-white/10 rounded-md px-3 py-2 text-sm"
          >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-[#0b1220] border border-white/10 rounded-md text-sm"
            />
          </div>
          ...
          <button
            ...
            className="flex items-center justify-center gap-2 bg-indigo-600 hover:bg-indigo-500 rounded-md text-sm font-medium"
          >
